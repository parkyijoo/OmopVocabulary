...
DRUG <- read.csv(
  file = file.path(dataFolder, "drug/drug.csv"),
  header = TRUE, sep = ",")

DRUG_HIRA <- read.csv(
  file = file.path(dataFolder, "drug/drughira.csv"),
  header = TRUE, sep = ",")
...
readr::write_tsv(x = conMap, file = file.path(dataFolder, "SourceToConceptMap/SourceToConceptMap2022.10.31.csv"),  na = "")
